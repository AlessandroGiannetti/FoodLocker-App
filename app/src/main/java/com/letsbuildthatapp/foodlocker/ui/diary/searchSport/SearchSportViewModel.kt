...
private const val TAG = "SEARCH SPORT VIEW MODEL"

class SearchSportViewModel : ViewModel() {
    ...
    var searchTextSport: String = ""


    private fun getSportProperties(sportName: String, view: View) {
        coroutineScope.launch {
            val getPropertiesDeferred = SportApi.retrofitServiceGetSportsByName.getSportsByName(sportName)
            try {
    ...
    fun submitSport(view: View) {
        ...
        getSportProperties(searchTextSport, view)
    }
